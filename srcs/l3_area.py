...
CITIES = 'G:\\GithubFiles\\Python\\examples\\Data Wrangling with MongoDB\\cities.csv'
...
def fix_area(area):
    ...
    if area == "NULL" or area == "":
        ...
        value1, value2 = area.split('|')
        value1 = value1[1:]
        value2 = value2[:-1]
        
        digits1, times1 = value1.split('+')
        digits2, times2 = value2.split('+')
